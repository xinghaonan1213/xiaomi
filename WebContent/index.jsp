        ...
        <div class="time_in">
			...
			<c:forEach items="${starGoodes }" var="goods">
				<div
					...
					<img class="time_min"
						style="width: 234px; height: 234px;" src="<%=imgPath %>${goods.pic}" alt="">
					</a>
    ...
    <div class="appliances">
        <div class="app_width">
            ...
            <div class="app_max">
                ...
                <img src="img/app_00.jpg" alt=""></a></div>
                <div class="appr">
                    <div class="appr_top">
                    	<!-- 循环后台取到的家电的集合 -->
						<c:forEach items="${homeGoodes }" var="goods" varStatus="i">
							<c:if test="${i.index<4}">
								<div class="appr_min" id="appr_min1"
									...
									<a href="<%=basePath %>index?func=findGoodsById&gid=${goods.gid}" target="_blank">
									<img width="180px"
										height="180px;" src="<%=imgPath %>${goods.pic}" alt=""></a>

									<div style="width: 234px; height: 100px;">
										<div
											style="width: 100%; height: 33px; text-align: center; font-size: 14px; font-family: Arial">${goods.gname }</div>
										<div
										...
										<div
											style="width: 100%; height: 33px; text-align: center; color: #ff6700; font-size: 14px; font-family: Arial">${goods.price }</div>
									</div>
								</div>
							</c:if>
							<c:if test="${i.index > 3 }">
            	...
            	<div class="capa_box scrip_capa_box scrip_capa_box_on">
					...
					<c:forEach items="${smartGoodes }" var="goods">
						...
						<div class="capa capa_shadow"
							style="width: 231px; height: 301px; text-align: center; background-color: #FFFFFF; margin-top: 15px;">
							<a href="<%=basePath %>index?func=findGoodsById&gid=${goods.gid}" target="_blank"> 
                ...
                <div class="capa_top">
					...
					<c:forEach items="${tjGoodes }" var="goods">
	                	<div class="capa capa_shadow" style="margin-right: 10px;background-color: #fff">
	                        <a href="<%=basePath %>index?func=findGoodsById&gid=${goods.gid}">
	                        <img width="234"  src="<%=imgPath %>${goods.pic}"></a>
	                        <div class="capa_a">
	                            <ul>
	                                <li style="color: #333333"> ${goods.gname } </li>
             ...
             <c:forEach items="${hotGoodes }" var="goods" varStatus="i">
            		...
            		<c:if test="${i.count ==1 }">
            			<div class="popu popu_unleft popu_shadow" >
	                        <a href="<%=basePath %>index?func=findGoodsById&gid=${goods.gid}" target="_blank"><img style="width: 296px" height="220px" src="<%=imgPath %>${goods.pic}"></a>
            		...
            		<c:if test="${i.count !=1 }">
            			<div class="popu popu_unleft popu_shadow" style="margin-left: 13px;">
	                        <a href="index?func=findGoodsById&gid=${goods.gid}" target="_blank"><img style="width: 296px" height="220px" src="<%=imgPath %>${goods.pic}"></a>
		                        <div class="popu_bottom">
		                            <p class="review">
		                                	外形简洁大方，大爱小米,附图，给客服妹子一个大嘴巴子
		                            </p>
		                            <p class="author"> 来自于 秘密 的评价 </p>
		                            <div class="info">
		                                <h3 class="title">${goods.gname }</h3>
